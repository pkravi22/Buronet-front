...
const PostSectionOld = () => {
  return (
    // Make container fluid with horizontal padding for smaller screens
    <div className="flex justify-center w-full px-4 sm:px-0">
      {/* Set a max-width for content readability on larger screens */}
      <div className="mt-6 w-full max-w-[640px] space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm">
          <div className="px-4 py-6 sm:px-6">
            ...
            <div className="flex justify-between items-start">
              <div className="flex">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-[#6B7280] text-[12px] mt-1">Senior Product Designer at TechCorp</p>
                </div>
              </div>
              <div className="flex items-center text-[#9CA3AF] text-[12px] shrink-0 ml-2">
                <span>2h ago</span>
            ...
            {/* Post Actions: Make them wrap on very small screens */}
            <div className="mt-6 flex flex-wrap justify-between gap-4">
              <div className="flex space-x-6">
                <button className="flex items-center text-[#4B5563] text-[12px]">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              <span className="bg-[#F3F4F6] text-[#4B5563] text-[12px] px-3 py-1 rounded-lg">
                #DesignSystems
              </span>
              <span className="bg-[#F3F4F6] text-[#4B5563] text-[12px] px-3 py-1 rounded-lg">
                #UXInnovation
        ...
        {/* Second Post (Similar responsive changes should be applied) */}
        <div className="bg-white rounded-xl shadow-sm">
           {/* Apply the same responsive classes to the second post as the first... */}
        </div>
      </div>
    </div>
  );
