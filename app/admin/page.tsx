...
const AdminPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6]">
      ...
      {/* Main Container */}
      <div className="max-w-[1124px] mx-auto pt-8 px-4 lg:px-0 lg:ml-[280px]">
          ...
          <aside className="w-full md:w-[280px] shrink-0">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden sticky top-8">
              ...
              <nav className="flex flex-col">
                <Link href="/profile" className="px-4 py-3 flex items-center gap-3 text-gray-600 hover:bg-gray-50 transition-colors">
                  <ArrowLeft size={18} />
                  <span className="text-sm font-medium">Back to Profile</span>
                </Link>
                
                <button
                  className="px-4 py-3 flex items-center gap-3 text-blue-600 bg-blue-50/50 border-r-4 border-blue-600 transition-colors"
                >
                  <Trash2 size={18} />
          ...
          <main className="flex-1">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="px-6 py-5 border-b bg-white">
                <h1 className="text-lg font-bold text-gray-900">Delete Bytes/Assets</h1>
                <p className="text-sm text-gray-600 mt-1">Remove assets from Cloudinary by providing their URL</p>
              </div>

              <div className="p-6">
                <form onSubmit={handleDeleteAsset} className="space-y-6">
                  <div>
                  ...
                  <button
                    ...
                    className="w-full px-6 py-3 bg-red-600 hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"
                  >
                    {isDeleting ? (
                      <>
                        <LoadingSpinner />
