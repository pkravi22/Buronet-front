    ...
    const fetchJobDetails = async () => {
      ...
      try {
        ...
        // if (jobResponse.success) {
          setJob(jobResponse as any); // Kept as per your original code
        // } else {
                  ...
                  <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                      ...
                      <div className="space-y-3">                                        
                        ...
                        <a href={`https://${splitAtFirst(job.applyLink?.link || '')[0]}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between bg-gray-50 rounded-lg p-4 hover:bg-blue-50 transition cursor-pointer">
