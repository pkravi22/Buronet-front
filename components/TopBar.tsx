          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => router.push('/home')}>
              <div className="flex items-center justify-center w-8 h-8">
                ...
                <img src="/Logo.PNG" alt="Buronet Logo" className="nav-logo-img w-full h-full object-contain" />
              </div>
              <span className="hidden sm:block text-[22px] font-bold text-[#0096c7] tracking-tight">
                Buronet
              </span>
            </div>
          </div>
                ...
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-[#E5E7EB] py-2 z-50">
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    ...
                    {notifications.map((notification) => (
                      <div
                        ...
                        className={`px-4 py-3 hover:bg-gray-50 cursor-pointer ${!notification.isRead ? 'bg-cyan-50' : ''
                          }`}
                      >
                  ...
                  {/* <div className="px-4 py-2 border-t border-[#E5E7EB]">
                            <button 
                                ...
                                className="w-full text-center text-[#0096c7] text-sm font-medium hover:text-[#0e7490]"
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[13px] font-medium text-gray-500 mt-0.5 truncate">
                          {userProfile?.headline || "Member"}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="py-2">
                    <Link href="/profile" className="w-full px-4 py-2.5 text-left text-[14px] font-semibold text-gray-700 hover:bg-cyan-50 hover:text-[#0096c7] flex items-center gap-3 transition-colors" onClick={() => router.push('/profile')}>
                      <FiUser size={16} />
                      <span>Profile</span>
                    </Link>
                    {isUserAdmin && (
                      <Link href="/admin" className="w-full px-4 py-2.5 text-left text-[14px] font-semibold text-gray-700 hover:bg-cyan-50 hover:text-[#0096c7] flex items-center gap-3 transition-colors" onClick={() => router.push('/admin')}>
                        <FiSettings size={16} />
                        <span>Admin Panel</span>
                      </Link>
                    )}
                    <button className="w-full px-4 py-2.5 text-left text-[14px] font-semibold text-red-600 hover:bg-red-50 flex items-center gap-3 transition-colors mt-1 border-t border-gray-100" onClick={logout}>
                      <FiLogOut size={16} />
                      <span>Logout</span>
                    </button>
                  </div>
